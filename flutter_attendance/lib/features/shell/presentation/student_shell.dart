...
/// Biometric unlock toggle. Shows whether the device supports biometrics
/// and lets the user enable/disable the app gate.
    ...
    if (!_available) {
      return Card(
        child: ListTile(
          ...
          trailing: const Icon(Icons.lock_outline, color: AppTheme.textMuted),
        ),
      );
    }
    return Card(
