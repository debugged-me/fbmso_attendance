                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Masterlist By Religion - <?php echo $data[0]->Religion; ?></h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <h4 class="m-t-0 header-title mb-4"><b>Masterlist By Religion<br />
                                            <span class="badge badge-primary mb-3"><?php echo $data[0]->Religion; ?></span>
                                        </b></h4>
