                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">SEARCH STUDENTS</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td style="text-align:center">
                                                    ...
                                                    <a href="<?= base_url(); ?>Page/submitRequest?id=<?php echo $row->StudentNumber; ?>&email=<?php echo $row->email; ?>&fname=<?php echo $row->FirstName; ?>&mname=<?php echo $row->MiddleName; ?>&lname=<?php echo $row->LastName; ?>"><button type="button" class="btn btn-info btn-xs">Add Request</button></a>
