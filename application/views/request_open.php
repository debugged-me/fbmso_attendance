                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Open Request</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <h4 class="m-t-0 header-title mb-4"><b>Open Request</b></h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                    <a href="<?= base_url(); ?>Page/studentRequestStat?trackingNo=<?php echo $row->trackingNo; ?>"><button type="button" class="btn btn-info btn-xs"><?php echo $row->trackingNo; ?>
