                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">TESDA PROGRAM MASTERLIST <br />
                                    <span class="badge badge-primary mb-3"><?php echo $data[0]->Major; ?></span>
                                </h4>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header py-3 bg-transparent">
                                            ...
                                            <h5 class="header-title mb-2"> Summary By Section</h5>
                                        </div>
                                                    ...
                                                    <table class="table mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($data2 as $row) {
                                                                ...
                                                                echo "<td style='text-align: center'>" . $row->enrolledCounts . "</td>";
                                                            ?>
                                                                <td style="text-align: center">
                                                                    <a href="<?= base_url(); ?>Masterlist/byQualifiationSection?section=<?php echo $row->Section; ?>&qual=<?php echo $row->Major; ?>"><button type="button" class="btn btn-success btn-xs">View List</button></a>
                                                                    <a href="<?= base_url(); ?>Masterlist/byQualifiationEmployement?section=<?php echo $row->Section; ?>&qual=<?php echo $row->Major; ?>"><button type="button" class="btn btn-info btn-xs">Employment Report</button></a>
                                                                </td>
                                                            <?php
                                                                echo "</tr>";
                                                            }
