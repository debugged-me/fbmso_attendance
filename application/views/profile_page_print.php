    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td>:
                    <?php echo $data[0]->Course1; ?> <?php if (!empty($data[0]->Major1)): ?> (Major: <?php echo $data[0]->Major1; ?>)<?php endif; ?><br>
                        : <?php echo $data[0]->Course2; ?> <?php if (!empty($data[0]->Major2)): ?> (Major: <?php echo $data[0]->Major2; ?>)<?php endif; ?><br>
                            : <?php echo $data[0]->Course3; ?> <?php if (!empty($data[0]->Major3)): ?> (Major: <?php echo $data[0]->Major3; ?>)<?php endif; ?>
                </td>
            </tr>
        </table>
        <table>
        ...
        <p style="text-align: justify;">
            As a student, I understand and agree that by providing my personal data, I am agreeing to the Data Privacy Policy and Terms of the <?php echo $data1->SchoolName; ?> and giving my full consent to the
            institution and its affiliates as well as its partners and service providers, if any, to collect, store, access and/or process any personal data I may provide herein, whether manually or electronically for the period AY ______________ until the Academic Year of my graduation or withdrawal/transfer
        ...
        <div class="sig">
            <p id="center"><strong><?php echo $data[0]->FirstName; ?> <?php echo $data[0]->MiddleName; ?> <?php echo $data[0]->LastName; ?></strong></p>
