                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Enrollees By Date</h4>
                                ...
                                <div class="card-body">
                                    <form method="GET" class="form-inline">
                                        <div class="form-group">
                                            <input type="date" name="date" class="form-control">&nbsp
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title mb-4">Enrollment Summary</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center"><?php echo $row->Enrollees; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
