...
$errHeading = isset($heading) && trim((string)$heading) !== '' ? trim((string)$heading) : 'Page not found';
$errMessage = isset($message) ? trim(strip_tags((string)$message)) : '';
if ($errMessage === '' || strcasecmp($errMessage, 'The page you requested was not found.') === 0) {
	$errMessage = 'The page you requested does not exist or may have been moved. Check the link or head back home.';
}
?><!DOCTYPE html>
<html lang="en">
<head>
...
<title>404 — <?= htmlspecialchars($errHeading, ENT_QUOTES, 'UTF-8'); ?></title>
<style>
