                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Released Request</h4>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <h4 class="m-t-0 header-title mb-4"><b>Released Request</b><br />
                                        <span class="badge badge-primary mb-3">Document Request Tracking</span>
                                    </h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                echo "<td>" . $row->procDate . ' ' . $row->procTime . "</td>";
                                                ?>
